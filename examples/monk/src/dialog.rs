...
impl Dialog {
    fn text(&self, progress: &GameProgression) -> String {
        match self {
            Dialog::Welcome => "Farewell Brother,
            ...
            Dialog::NoWheatToBake => "Hello Brother! We have nothing to bake...
                ...
                (Enter)"
                .to_string(),
            Dialog::DelegateBake => "Hello Brother! Shall I begin baking bread?
                
                (Y,N)"
                .to_string(),
            Dialog::DelegateHops => "Hello Brother! Shall I begin planting hops?
                
                (Y/N)"
                .to_string(),
            Dialog::DelegateBeer => "Hello Brother! Shall I begin brewing beer?
            ...
            Dialog::PendingDelegateBake => "I'll start baking tomorrow!
                ...
                (Enter)"
                .to_string(),
            Dialog::PendingDelegateHops => "I'll start planting tomorrow!
                
                (Enter)"
                .to_string(),
            Dialog::PendingDelegateBeer => "I'll start brewing tomorrow!
            ...
            Dialog::PendingDelegatePaper => "I'll start making paper tomorrow!
                ...
                (Enter)"
                .to_string(),
            Dialog::OldDesk => "An old desk... it hasn't been used for years.
            ...
            Dialog::WriteLetter => {
                ...
                if letters.is_empty() {
                    ...
                    format!(
                        "{}
                        (Enter): Write to nobody.",
                        options.join("\n")
                    )
                }
            }
            Dialog::NoMorePaper => "The desk papers have been used up. There will be more tomorrow.
            ...
            Dialog::ReplyBeer => "1: Make and cool the wort with water, grains, and hops
            ...
            Dialog::ReplyGuests => "Beer? My, erm, advisors have advised me to come at once!
                - His Majesty, the King
                
                (Enter)"
                .to_string(),
            Dialog::King => "Beer! You have kept the tradition of the this monestary alive!
    ...
    pub fn process(&self, global: &mut Global, input: &Input) -> bool {
        let mut should_close = false;

        match self {
            Dialog::SleepConfirm => {
                if input.key_down(Key::Y) {
                    ...
                    if global.progress.sent_eastern_monestary
                        && !global.progress.reply_eastern_purpose
                    {
                    ...
                    if global.progress.sent_northern_monestary
                        && !global.progress.reply_northern_beer
                    {
                    ...
                    if global.progress.sent_southern_monestary
                        && !global.progress.reply_southern_hops
                    {
